...
class Message extends React.PureComponent<IProps & WithStyles<typeof styles>> {
  ...
  public componentDidMount = () => this.props.height(this.node ? this.node.getBoundingClientRect().height : 0)
      ...
      <div className={`${classes.wrapperPadding} message`} ref={(ref) => (this.node = ref)}>
        <Container style={{ display: 'flex' }}>
          <div className={classes.imageWrapper}>
            {image !== null ? <img src={config.get('url') + image} alt="app logo" width="70" height="70" className={classes.image} /> : null}
          </div>
